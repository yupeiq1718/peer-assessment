...
<template>
  <header class="bg-white rounded-2xl px-6 py-4 flex justify-between items-center">
  ...
  <article class="grid grid-cols-1 lg:grid-cols-2">
    <section class="bg-white rounded-2xl px-6 py-4 my-4 mr-2">
    ...
    <section class="bg-white rounded-2xl px-6 py-4 my-4 ml-2">
      <h2 class="text-lg font-bold text-dark mb-2">
        {{ systemStatus[1].text }}：
      </h2>
      <p class="text-dark">
