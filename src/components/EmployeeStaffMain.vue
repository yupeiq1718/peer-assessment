...
<template>
  <table class="relative border-separate border-spacing-x-0 border-spacing-y-4 text-dark text-center min-w-full">
    <thead>
      <tr class="mb-4">
        <td
    ...
    <tbody>
      <tr
        ...
        :key="data.name"
      >
        <td class="px-8 py-4 border-y-2 first:border-l-2 last:border-r-2 border-muted first:rounded-l-2xl last:rounded-r-2xl bg-white">
